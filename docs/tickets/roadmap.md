...
| # | 機能 | Status | Priority | 概要 |
|---|------|--------|----------|------|
| 2.1 | カード機能拡張 | 🔴 未着手 | 🔵 Medium | タグ/ラベル、期限設定、優先度、担当者（アサイニー）機能 |
| 2.2 | 検索・フィルター | 🔴 未着手 | 🔵 Medium | カード全文検索、タグ/ラベルフィルタ、期限ソート |
| 2.3 | アクティビティログ | 🔴 未着手 | ⚪ Low | カード/リスト変更履歴、誰がいつ何を変更したか記録、アクティビティフィード |
| 2.4 | ボード間カード移動 | 🔴 未着手 | ⚪ Low | ボード間でカードをドラッグ&ドロップで移動 |
